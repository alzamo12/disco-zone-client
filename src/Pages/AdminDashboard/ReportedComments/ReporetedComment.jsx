            ...
            >
                ...
                <td className="px-4 py-3 text-center flex gap-2 space-x-2">
                    <motion.button
                        ...
                        className="px-3 py-1 btn-outline border cursor-pointer border-accent rounded-md text-sm font-medium disabled:opacity-50"
                    >
                        Delete
                    </motion.button>
                    <motion.button
                        ...
                        className="px-3 py-1 bg-accent cursor-pointer rounded-md text-sm font-medium disabled:opacity-50"
                    >
                        Dismiss
                    </motion.button>
                </td>
